...
save(pval.combined.marot, file="PGC_EWAS_smoking_inverseNorm_intersectSites_civilian.Rdata")
...
save(results, file="PGC_EWAS_smoking_inverseNorm_remainingSites_civilian.Rdata")
rm(list=ls())
