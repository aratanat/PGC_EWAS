...
homeDir<-"/Users/ar3054/Documents/R/PGC_EWAS/Current/PGC_EWAS/Civilian/Smoking/"
...
setwd(homeDir)
save.image("PGC_EWAS_combinedData_civilian_smoking.Rdata")
rm(list=ls())
...
write.csv(tab, "PGC_EWAS_individualCohort_results_civilian_smoking.csv")
