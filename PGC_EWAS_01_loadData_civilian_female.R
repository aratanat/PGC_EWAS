...
setwd("/Users/ar3054/Dropbox/PTSD methylation workgroup Results Files/Gender-Stratified/Non-Smoking/Female/")
homeDir<-"/Users/ar3054/Documents/R/PGC_EWAS/Current/PGC_EWAS/Civilian/Female/"
...
load("DNHS100_limma_results_femalesOnly_08.09.16.Rdata")
DNHS.coef<-fit.coef
rm(fit.coef)
...
load("GTP_limma_results_females_02.26.17.Rdata")
GTP.coef<-fit.coef
rm(fit.coef)
results<-results[order(results[, "P.Value"]), ]
GTP.results<-results
...
setwd(homeDir)
save.image("PGC_EWAS_combinedData_civilian_female.Rdata")
rm(list=ls())
...
write.csv(tab, "PGC_EWAS_individualCohort_results_civilian_female.csv")
