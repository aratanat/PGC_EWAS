...
homeDir<-"/Users/ar3054/Documents/R/PGC_EWAS/Current/PGC_EWAS/Civilian/nonSmoke/"
...
setwd(homeDir)
save.image("PGC_EWAS_combinedData_civilian.Rdata")
rm(list=ls())
...
write.csv(tab, "PGC_EWAS_individualCohort_results_civilian.csv")
