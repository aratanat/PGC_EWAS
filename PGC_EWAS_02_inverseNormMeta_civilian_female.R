...
load("PGC_EWAS_combinedData_civilian_female.Rdata")
...
save.image("PGC_EWAS_DataPrep_nonSmoke_civilian_female.Rdata")
...
save.image("PGC_EWAS_DataPrep_nonSmoke_intersectSites_civilian_female.Rdata")
...
save.image("PGC_EWAS_DataPrep_nonSmoke_remainingSites_civilian_female.Rdata")
...
load("PGC_EWAS_DataPrep_nonSmoke_intersectSites_civilian_female.Rdata")
...
save(pval.combined.marot, file="PGC_EWAS_nonSmoke_inverseNorm_intersectSites_civilian_female.Rdata")
...
load("PGC_EWAS_DataPrep_nonSmoke_remainingSites_civilian_female.Rdata")
sites<-unique(sites)
sites<-sites[!sites%in%all]

# Step 2B: Add to list of sites the Study IDs
studies<-matrix(FALSE, nrow=length(sites), ncol=2)
colnames(studies)<-c("DNHS", "GTP")
...
save(results, file="PGC_EWAS_nonSmoke_inverseNorm_remainingSites_civilian_female.Rdata")
rm(list=ls())
